...
import Features from '@/components/Features'; // Import the new component

export default function Home() {
  return (
    <>
      <Header />
      <main className="w-full max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-12">
        {/* Left Content Block */}
      ...
      <SocialProof />
      <Features /> {/* Add the new component here */}
    </>
  );
}